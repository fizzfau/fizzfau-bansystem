...
local sebep = {}
local webhook = {
	ban = "buraya webhook gelecek",
	kick = "buraya webhook gelecek",
	unban = "buraya webhook gelecek",
	connect = "buraya webhook gelecek",
...
RegisterCommand("ban", function(source, args)
	...
	if player.getGroup() == "admin" or source == 0 then
		...
		DropPlayer(tplayer.source, " G.o kanka banlandın \n Banlanma Sebebi: " ..sebep)
